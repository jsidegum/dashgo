...
export default function UserList() {
    ...
    async function handlePrefetchUser(userId: string) {
        await queryClient.prefetchQuery(['users', userId], async () => {
            ...
            staleTime: 1000 * 60 * 10 //10 minutos - Tempo para ficar obsoleto
        })
    }
                            ...
                            <Table colorScheme="whitAlpha">
                                <Thead>
                                    <Tr>
                                        ...
                                        {isWideVersion && <Th>Data de Cadastro</Th>} {/*Para retirar a Data caso esteja na versão mobile*/}
                                        <Th width="8">
                                        </Th>
                                    </Tr>
                                </Thead>
                                    ...
                                    {data.users.map(user => {
                                        return (
                                            <Tr key={user.id}>
                                                ...
                                                {isWideVersion && <Td>{user.createdAt}</Td>} {/*Para retirar a Data caso esteja na versão mobile*/}
                                                <Td>
                                                    <Button
                                                        as="a"
                                                        size="sm"
